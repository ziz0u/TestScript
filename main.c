...
/*
 * main.c
 * Copyright (C) 2015 Juan <el-john@Mountain-Lion>
 * 
...
struct _Private
{
	/* ANJUTA: Widgets declaration for test.ui - DO NOT REMOVE */
};
...
create_window (void)
{
	...
	/* ANJUTA: Widgets initialization for test.ui - DO NOT REMOVE */
